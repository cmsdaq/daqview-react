...
(function (DAQView) {
    ...
    var SnapshotModalElement = (function (_super) {
        ...
        SnapshotModalElement.prototype.render = function () {
            return (React.createElement("div", null, React.createElement("button", {className: "button-share"}, "Share"), React.createElement("a", {href: this.props.url, target: "_blank"}, React.createElement("button", {className: "button-snapshot"}, "See raw DAQ snapshot"))));
        };
