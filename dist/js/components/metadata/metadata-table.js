...
(function (DAQView) {
    ...
    var MetadataTableElement = (function (_super) {
        ...
        MetadataTableElement.prototype.render = function () {
            ...
            return (React.createElement("table", {className: "metadata-table"}, React.createElement("thead", {className: "metadata-table-head"}, React.createElement("tr", {className: "metadata-table-header-row"}, React.createElement("th", null, "Run number"), React.createElement("th", null, "Run start time (local)"), React.createElement("th", null, "LV0 state"), React.createElement("th", null, "LV0 state entry time (local)"), React.createElement("th", null, "DAQ state"), React.createElement("th", null, "Machine state"), React.createElement("th", null, "Beam state"), React.createElement("th", null, "Session ID"), React.createElement("th", null, "DAQ configuration"), React.createElement("th", null, "Snapshot time (local)"))), React.createElement("tbody", {className: "metadata-table-body"}, React.createElement("tr", {className: "metadata-table-content-row"}, React.createElement("td", null, React.createElement("a", {href: this.props.runInfoTimelineLink + "?run=" + (this.props.runNumber ? this.props.runNumber : '0'), target: "_blank"}, (this.props.runNumber ? this.props.runNumber : '0'))), React.createElement("td", null, React.createElement("div", null, this.props.runStartTime ? this.formatHumanReadableTimestamp(this.props.runStartTime) : 'Not started'), React.createElement("div", {className: "metadata-table-run-duration"}, durationDescription)), React.createElement("td", null, this.props.lv0State), React.createElement("td", null, this.props.lv0StateTimestamp ? this.formatHumanReadableTimestamp(this.props.lv0StateTimestamp) : 'Unknown'), React.createElement("td", null, this.props.daqState), React.createElement("td", null, this.props.machineState), React.createElement("td", null, this.props.beamState), React.createElement("td", null, React.createElement("a", {href: this.props.runInfoTimelineLink + "?sessionId=" + this.props.sessionId, target: "_blank"}, this.props.sessionId)), React.createElement("td", null, this.props.dpSetPath), React.createElement("td", {className: timestampClass}, React.createElement("div", {title: snapshotOnHoverMessage}, this.formatHumanReadableTimestamp(this.props.snapshotTimestamp)))))));
        };
